...
NAME_TO_TYPE = {'v2-8':'v2-8','v2-32':'v2-32','v2-64':'v2-64','v2-128':'v2-128','v3-8':'v3-8','v3-32':'v3-32','v3-64':'v3-64','v3-128':'v3-128','v4-8':'v4-8','v4-16':'v4-16','v4-32':'v4-32','v4-64':'v4-64','v4-128':'v4-128','v4-256':'v4-256','v4-512':'v4-512','v5e-8':'v5litepod-8','v5e-16':'v5litepod-16','v5e-32':'v5litepod-32','v5e-64':'v5litepod-64','v6e-8':'v6e-8','v6e-16':'v6e-16','v6e-32':'v6e-32','v6e-64':'v6e-64', 'v6e-128': 'v6e-128', 'v6e-256': 'v6e-256', 'v6e-512': 'v6e-512'}
NAME_TO_VER = {'v2':'v2','v3':'v3','v4':'v4','v5e':'v5e','v6e':'v6e'}
v2_list = ['v2-8', 'v2-16', 'v2-32', 'v2-64', 'v2-128']
v3_list = ['v3-8', 'v3-16', 'v3-32', 'v3-64', 'v3-128']
v4_list = ['v4-8', 'v4-16', 'v4-32', 'v4-64', 'v4-128', 'v4-256', 'v4-512']
v5_list = ['v5-8', 'v5-16', 'v5-32', 'v5-64', 'v5-128']
v6_list = ['v6-8', 'v6-16', 'v6-32', 'v6-64', 'v6-128', 'v6-256', 'v6-512']
v5e_list = ['v5litepod-8', 'v5litepod-16', 'v5litepod-32', 'v5litepod-64', 'v5litepod-128']
v6e_list = ['v6e-8', 'v6e-16', 'v6e-32', 'v6e-64', 'v6e-128', 'v6e-256', 'v6e-512']
...
# ------------ monitor config ----------
COL_WIDTH = 26         # width of EACH job column
KEY_COL_MIN = 7
KEY_COL_MAX = 12
